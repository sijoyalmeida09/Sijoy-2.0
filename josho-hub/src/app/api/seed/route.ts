...
// Run by visiting: https://music.joshoit.com/api/seed?key=josho2026

const SEED_KEY = "josho2026";

const SEED_USERS = [
  {
    email: "admin@joshoit.com",
    password: "JoShoAdmin2026!",
    role: "admin",
    full_name: "Sijoy Admin"
  },
  {
    email: "artist@joshoit.com",
    password: "JoShoArtist2026!",
    role: "musician",
  ...
  {
    email: "client@joshoit.com",
    password: "JoShoClient2026!",
    role: "client",
